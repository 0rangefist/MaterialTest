...
public class TransactionListAdapter  extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            holder.transactionTv = (TextView)view.findViewById(R.id.id_field);
            holder.accFromTv = (TextView)view.findViewById(R.id.from_field);
            holder.stateTv = (TextView)view.findViewById(R.id.state_field);
            holder.eventTv = (TextView)view.findViewById(R.id.event_field);
            holder.amountTv = (TextView)view.findViewById(R.id.amount_field);
            view.setTag(holder);
        } else {
            view = convertView;
